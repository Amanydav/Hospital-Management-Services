...
export default function Gallery() {
  ...
  // Using useMediaQuery to adjust the number of columns based on screen width
  ...
  const cols = isLg ? 4 : isMd ? 3 : isXs ? 2 : 3; // 4 for large screens, 3 for medium screens, 2 for small screens
